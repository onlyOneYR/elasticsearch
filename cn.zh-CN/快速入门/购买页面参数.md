...
-   **预付费**：目前预付费阿里云Elasticsearch实例的优惠条件，是基于固定使用期限（包年包月）为前提。您在购买预付费阿里云Elasticsearch产品后，支持5天内退余款。超过5天后，将不再支持退余款。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134283/156283931939941_zh-CN.png)
...
-   **后付费**：在前期程序研发或功能测试期间，建议购买**后付费**（按量付费）类型的阿里云Elasticsearch实例进行测试。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134283/156283932039942_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134283/156283932039943_zh-CN.png)
