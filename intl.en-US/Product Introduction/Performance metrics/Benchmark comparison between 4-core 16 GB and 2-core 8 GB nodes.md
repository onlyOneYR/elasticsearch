# Benchmark comparison between 4-core 16 GB and 2-core 8 GB nodes {#concept_1443296 .concept}

This topic compares the benchmarks of two Elasticsearch clusters: one cluster contains three 4-core 16 GB nodes and the other contains three 2-core 8 GB nodes.
