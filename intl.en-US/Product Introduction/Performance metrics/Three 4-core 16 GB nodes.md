# Three 4-core 16 GB nodes {#concept_1443292 .concept}

This topic lists the performance metrics of an Elasticsearch cluster that contains three 4-core 16 GB nodes. The metrics include the Kibana metrics during the benchmarking process and other performance metrics.
...
## Kibana metrics during the benchmarking process {#section_geq_nw9_lke .section}

![Kibana metrics of three 4-core 16 GB nodes](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/134274/156626840739909_en-US.png)

## Performance metrics {#section_6g2_vk3_g2d .section}
