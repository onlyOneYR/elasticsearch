...
-   To access an Elasticsearch instance from the Internet, you must first create a [公网地址访问白名单](../../../../../intl.en-US/User Guide/Instance management/安全配置.md#section_ux5_yct_zgb), By default, no public addresses are allowed to access Elasticsearch.
